      ...
      <main className="flex-grow">
        ...
        <section className="py-12 md:py-20 relative overflow-hidden bg-white">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="text-center mb-12">
              <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight text-forest-900">{t('how_it_works_title')}</h2>
        ...
        <section className="py-12 md:py-24 bg-white bg-gradient-to-b from-slate-800/5 via-forest-900/3 to-transparent relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="font-display text-3xl md:text-4xl font-black uppercase tracking-tight mb-6 flex items-center gap-3 text-forest-900">
        ...
        <section className="py-12 md:py-20 bg-white bg-gradient-to-b from-forest-900/8 via-steel-700/5 to-transparent relative overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight text-forest-900">{t('popular_services_title')}</h2>
        ...
        <section id="cta-section" className="py-12 md:py-20 text-center relative overflow-hidden bg-white">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-tight text-forest-900">{t('cta_ready_title')}</h2>
